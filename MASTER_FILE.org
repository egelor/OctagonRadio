...
~octmonit.stop;
#+END_SRC
**  Microphone ment Or Second microphodne
   :PROPERTIES:
   :DATE:     <2019-12-29 Sun 16:59>
   :END:
   #+Title: Second Input from SoundCard
#+BEGIN_SRC sclang Mic with eq~instmic = Synth("\inst");
...
var input;
var numc,numa,temp;
input=AudioIn.ar(1,2); //get two channels of input starting (and ending) on bus 0
...
r= Synth.tail(a, \fxexamplereverb, [\delaytime, 0.0001]);
